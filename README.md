...
사용하는 `font-family`의 이름은 `Nanum Myeongjo YetHangul`입니다.
...
```css
font-family: "Nanum Myeongjo YetHangul", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Oxygen, Ubuntu, Cantarell, "Open Sans", "Helvetica Neue", sans-serif;
```
